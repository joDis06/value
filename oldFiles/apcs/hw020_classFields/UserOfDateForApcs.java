...
public class UserOfDateForApcs {
    ...
    // start/end year values
    System.out.println(DateForApcs.yearStart);
    System.out.println(DateForApcs.yearEnd);
     ...
     */
    private static DateForApcs myDateForApcs( int yyyy
                                           , int mm
                                           , int dd
                                           ) {
        DateForApcs aDate;
    ...
    /*
      Display advanceCurrentYear
     */
    public static String advanceCurrentYearTest()
}
